...
const FORK_TEST_CONTRACT = "test/extensions/GmxFallbackFork.t.sol";
...
function buildForkTestFile() {
  const lines = [
    ...
    'import {_GMX_DATA_STORE, _FLOAT_PRECISION} from "../../contracts/protocol/types/GmxConstants.sol";',
    'import {GmxFallback, Feed, getFallbackPriceFeed} from "../../contracts/protocol/types/GmxFallback.sol";',
    "",
    "/// @title GmxFallbackFork",
    "/// @notice Fork test that verifies the hardcoded fallback metadata matches on-chain reality.",
    "/// @dev This file is generated by scripts/gmx/generate_gmx_fallback_solidity.js.",
    "///  Do not edit manually; re-run the generator after updating the JSON source.",
    "contract GmxFallbackFork is Test {",
    "    struct FallbackEntry {",
    "        address token;",
    "        address feed;",
    "        uint8 feedDecimals;",
  ...
  lines.push(
    ...
    '        vm.createSelectFork("arbitrum");',
    "",
    "        uint256[] memory expectedPrices = new uint256[](entries.length);",
    ...
    "",
    "        for (uint256 i; i < entries.length; ++i) {",
    "            Price.Props memory price = GmxFallback.getFallbackPrice(entries[i].token);",
...
function patchForkTest() {
  fs.writeFileSync(FORK_TEST_CONTRACT, buildForkTestFile(), "utf8");
  console.log(
