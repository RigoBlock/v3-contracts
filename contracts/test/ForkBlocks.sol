...
library ForkBlocks {
    ...
    /// @dev Previously pinned just before TX1/TX2/TX3 replayed by A0xRouterUnichainFork tests;
    ///      those tests pin their own replay blocks, so a recent global pin is safe.
