...
///  Each entry is packed as `uint168(feedAddress << 8 | exponent)`.
function getFallbackPriceFeed(address token) pure returns (Feed) {
    ...
    if (nibble < 3) {
        if (token == 0x0315441076FF6d3eA09814a2F90a1f980cF03e9e) packed = 0x46306f3795342117721d8ded50fbcf6df2b3cc1022;
        if (token == 0x13674172E6E44D31d4bE489d5184f3457c40153A) packed = 0x8c76e8cab5ef3b410a318ddb82d83ed47d7d270128;
        if (token == 0x13983f27Ce9365055a6a553233c49fE28e70103e) packed = 0xcca91a477fbf466d676b2056bfdfda94f343a64f22;
        if (token == 0x197aa2DE1313c7AD50184234490E12409B2a1f95) packed = 0x4a85b128ebdafc24d5cb611e161376ffdeceb2892b;
        if (token == 0x2aAB60E62f05d17e58dEc982870bfAdc7F4e7ADF) packed = 0xad57d7c059e2afef2241eb6ef43559f8a409897e22;
        if (token == 0x2e73bDBee83D91623736D514b0BB41f2afd9C7Fd) packed = 0x1b47b4124b9a5094c59710e6b9126e5e32a4fb8e18;
    } else if (nibble < 7) {
        ...
        if (token == 0x9759C297fb6C91e252c7292cECa30a509558E5De) packed = 0xa0c8611b0cfb31bc8ade3189ae2b982c90d9302f22;
        if (token == 0x97Ce1F309B949f7FBC4f58c5cb6aa417A5ff8964) packed = 0x17d8d87df3e279c737568ab0c5cc3ff750ab763e22;
        if (token == 0x9c060B2fA953b5f69879a8B7B81f62BFfEF360be) packed = 0x0c997958cce7a0403aea7e34d14bbada897b5bb318;
        if (token == 0x9c74772b713a1B032aEB173E28683D937E51921c) packed = 0x82ba56a2fadf9c14f17d08bc51bda0bdb83a893422;
    } else if (nibble < 13) {
        if (token == 0xB2f7cefaeEb08Aa347705ac829a7b8bE2FB560f3) packed = 0x0301e5d0a8f7490444ebd1921e3d0f0fe77227862b;
        if (token == 0xB46A094Bc4B0adBD801E14b9DB95e05E28962764) packed = 0x5698690a7b7b84f6aa985ef7690a8a7288fbc9c82c;
        if (token == 0xB79Eb5BA64A167676694bB41bc1640F95d309a2F) packed = 0xe56bea9ff0780d668f92a9ab4ace1d713caa101622;
        if (token == 0xBaf07cF91D413C0aCB2b7444B9Bf13b4e03c9D71) packed = 0x3a9659c071dd3c37a8b1a2363409a8d41b2feae32e;
        if (token == 0xC5799ab6E2818fD8d0788dB8D156B0c5db1Bf97b) packed = 0x4b13dd76de990db9a2dab58d35c2c02e5e3ae84822;
        if (token == 0xc5dbD52Ae5a927Cf585B884011d0C7631C9974c6) packed = 0x5a0a07cd0e9e4754b3fec4fb1ee1a5babbaa605123;
    } else {
        if (token == 0xE6172EecBB07F197F52bb73d74daa0e19C31c4Db) packed = 0x569dca98c58d7a89cee87801805a8eaaf2c72b5b22;
        if (token == 0xEcc5eb985Ddbb8335b175b0A2A1144E4c978F1f6) packed = 0x0b2ab7ae5276f6f466f8e62953138b106dd19a6322;
        if (token == 0xF67b2a901D674B443Fa9f6DB2A689B37c07fD4fE) packed = 0x1e48733eeee02468b674b69958b046eb6a0a7d9422;
    }
...
library GmxFallback {
    ...
    function getFallbackPrice(address token) internal view returns (Price.Props memory price) {
        ...
        address feed = address(uint160(packedData >> 8));
        if (feed == address(0)) return price;
        uint256 multiplier = 10 ** (packedData & type(uint8).max);
