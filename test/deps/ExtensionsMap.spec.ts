...
describe("ExtensionsMapDeployer", async () => {
    ...
    describe("deployExtensionsMap", async () => {
        it('should not re-deploy if salt has not changed', async () => {
            ...
            const extensions = {eApps: user1.address, eOracle: user1.address, eUpgrade: user1.address, eCrosschain: user1.address, eNavView: user1.address, eGmxCallback: user1.address}
